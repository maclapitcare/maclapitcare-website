...
export default function MacBookAirA2941ScreenReplacement() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute("content", "Expert MacBook Air A2941 Display Replacement in Delhi NCR. MacLap IT Care offers professional M2 screen replacement with certified technicians, genuine parts & warranty. Call 9211720790");
    }
  }, []);
  ...
  const compatibleModels = [
    ...
    "EMC 3673",
    "MQKQ3 (Midnight, 256GB)",
    "MQKP3 (Starlight, 256GB)", 
    "MQKN3 (Space Gray, 256GB)",
    "MQKL3 (Silver, 256GB)",
    "MQKR3 (Midnight, 512GB)",
    "MQKW3 (Starlight, 512GB)",
    "MQKV3 (Space Gray, 512GB)",
    "MQKU3 (Silver, 512GB)"
  ];
  ...
  const repairProcess = [
    {
      ...
      description: "Complete A2941 display and system functionality evaluation"
    },
    {
      step: "2", 
      title: "Safe Disassembly",
      description: "Careful removal of A2941 display assembly and components"
    },
    {
      step: "3",
      title: "Display Removal",
      description: "Professional removal of damaged screen from A2941 unit"
    },
    {
      step: "4",
      title: "Quality Component Install",
      description: "Installation of genuine A2941-compatible display assembly"
    },
    {
      step: "5",
  ...
  const whyChooseUs = [
    {
      icon: Award,
      title: "A2941 Specialists",
      description: "Extensive experience with MacBook Air M2 15-inch display replacements"
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "Most A2941 screen replacements completed same day"
    },
    {
      icon: Star,
  ...
  const customerReviews = [
    {
      ...
      rating: 5,
      review: "Dropped my MacBook Air 15-inch and screen cracked completely. These guys fixed it in same day. Display looks exactly like before - True Tone and everything working fine. Fair price too.",
  ...
  const faqs = [
    {
      ...
      answer: "A2941 is the model number for MacBook Air 15-inch M2 (2023). You can find this number on the bottom of your MacBook or in Apple Menu > About This Mac. It includes all M2 MacBook Air 15-inch variants released in 2023."
    },
    {
      question: "What's included in A2941 screen replacement service?",
      answer: "Our A2941 screen replacement includes genuine display assembly, expert installation, quality testing, and 3-month warranty. We also provide free pickup/delivery across Delhi NCR and same-day service for urgent cases."
    },
    {
      question: "Will the replacement screen support True Tone on my A2941?",
      answer: "Yes, our genuine A2941 display assemblies fully support True Tone, P3 wide color gamut, and all original features. The replacement maintains the same 2880x1864 resolution and 500 nits brightness as original."
    },
    {
      question: "How long does A2941 screen replacement take?",
    ...
    },
    {
      ...
      answer: "Yes, we provide up to 3-month comprehensive warranty on A2941 screen replacement including display quality, installation workmanship, and functionality. No questions asked replacement if any issues arise."
    },
    {
      question: "Can you repair A2941 screen damage without full replacement?",
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-2 mb-6">
                  <Badge className="bg-white/20 text-white text-xs px-3 py-1">A2941 Specialists</Badge>
                  <Badge className="bg-white/20 text-white text-xs px-3 py-1">M2 15-inch Model</Badge>
                ...
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                  ...
                  >
                    ...
                    <span className="relative z-10 text-blue-900 font-semibold">Book A2941 Screen Repair</span>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Verify your exact MacBook Air M2 15-inch model before booking repair service
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">A2941 Display Specifications</h2>
            <p className="text-xl text-muted-foreground">
              Technical details of your MacBook Air M2 15-inch display
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Our A2941 Screen Replacement Process</h2>
            <p className="text-xl text-muted-foreground">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Real experiences from A2941 repair customers
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Common questions about A2941 screen replacement service
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-purple-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Fix Your MacBook Air A2941 Screen?
          </h2>
