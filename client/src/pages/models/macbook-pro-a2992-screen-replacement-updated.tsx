...
export default function MacBookProA2992ScreenReplacement() {
  ...
  useEffect(() => {
    document.title = "MacBook Pro A2992 Display Replacement in Delhi NCR | Best Service | MacLap IT Care";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Expert MacBook Pro A2992 Display Replacement in Delhi NCR. MacLap IT Care offers professional M3 Max 16-inch screen replacement with certified technicians, genuine parts & warranty. Call 9211720790");
    }
  }, []);
  ...
  const compatibleModels = [
    ...
    "EMC 4078",
    "MRW13 (Space Black, 36GB, 512GB)",
    "MRW23 (Silver, 36GB, 512GB)", 
    "MRW33 (Space Black, 36GB, 1TB)",
    "MRW43 (Silver, 36GB, 1TB)",
    "MRW53 (Space Black, 128GB, 4TB)",
    "MRW63 (Silver, 128GB, 4TB)",
    "MRW73 (Space Black, 128GB, 8TB)",
    "MRW83 (Silver, 128GB, 8TB)"
  ];

  const screenSpecs = [
    { spec: "Display Size", value: "16.2-inch Liquid Retina XDR Display" },
  ...
  const repairProcess = [
    {
      ...
      description: "Complete A2992 XDR display and M3 Max system evaluation"
    },
    {
      step: "2", 
      title: "Safe Disassembly",
      description: "Careful removal of A2992 premium display assembly"
    },
    {
      step: "3",
    ...
    },
    {
      ...
      description: "Installation of genuine A2992 Liquid Retina XDR assembly"
    },
    {
      step: "5",
  ...
  const whyChooseUs = [
    {
      icon: Award,
      title: "A2992 XDR Specialists",
      description: "Extensive experience with MacBook Pro M3 Max 16-inch XDR display replacements"
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "Most A2992 XDR screen replacements completed same day"
    },
    {
      icon: Star,
  ...
  const customerReviews = [
    {
      ...
      rating: 5,
      review: "Dropped my MacBook Pro M3 Max and XDR screen cracked completely. These guys fixed it in same day. Display looks exactly like before - HDR and ProMotion working perfectly. Expensive but worth it.",
      device: "MacBook Pro M3 Max 16-inch"
    },
    {
      name: "Sneha Agarwal", 
      location: "Cyber City, Gurgaon",
      rating: 5,
      review: "Had mini-LED backlight issues with dark zones. MacLap IT Care replaced the XDR display professionally. Now HDR content looks amazing again. Great service for premium laptop.",
    ...
    },
    {
      ...
      rating: 4,
      review: "ProMotion was flickering badly during video editing. They diagnosed XDR controller failure and replaced entire display. Fixed all issues. Professional service for high-end MacBook.",
  ...
  const faqs = [
    {
      question: "What is MacBook Pro A2992 and how do I identify it?",
      answer: "A2992 is the model number for MacBook Pro 16-inch M3 Max (2023). You can find this number on the bottom of your MacBook or in Apple Menu > About This Mac. It includes all M3 Max MacBook Pro 16-inch variants released in late 2023."
    },
    {
      question: "What's included in A2992 XDR screen replacement service?",
      answer: "Our A2992 screen replacement includes genuine Liquid Retina XDR display assembly, expert installation, quality testing, and 3-month warranty. We also provide free pickup/delivery across Delhi NCR and same-day service for urgent cases."
    },
    {
      question: "Will the replacement XDR screen support all features on my A2992?",
      answer: "Yes, our genuine A2992 XDR display assemblies fully support Mini-LED, ProMotion up to 120Hz, HDR with 1600 nits peak brightness, P3 wide color gamut, and True Tone. All original premium features maintained."
    },
    {
      question: "How long does A2992 XDR screen replacement take?",
      answer: "Most MacBook Pro A2992 XDR screen replacements are completed within 6-8 hours due to complexity. Same-day service is available for urgent cases. We also offer free pickup and delivery across Delhi NCR."
    },
    {
      question: "Is the A2992 XDR screen replacement covered under warranty?",
      answer: "Yes, we provide up to 3-month comprehensive warranty on A2992 XDR screen replacement including display quality, installation workmanship, and functionality. No questions asked replacement if any issues arise."
    },
    {
      question: "Can you repair A2992 XDR screen damage without full replacement?",
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-2 mb-6">
                  <Badge className="bg-white/20 text-white text-xs px-3 py-1">A2992 XDR Specialists</Badge>
                  <Badge className="bg-white/20 text-white text-xs px-3 py-1">M3 Max 16-inch</Badge>
                  <Badge className="bg-white/20 text-white text-xs px-3 py-1">Up to 3 Months Warranty</Badge>
                </div>
                <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                  MacBook Pro A2992<br />
                  <span className="text-blue-200">Display Replacement in Delhi NCR</span>
                </h1>
                <p className="text-xl mb-8 leading-relaxed">
                  MacLap IT Care offers expert MacBook Pro A2992 Display Replacement services. Our certified technicians have the expertise to confidently tackle this job with advance tools and technology. We offer professional replacement process using high-quality screen to provide you that same user experience back.
                </p>
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                  ...
                  >
                    ...
                    <span className="relative z-10 text-blue-900 font-semibold">Book A2992 XDR Repair</span>
              ...
              <div className="flex justify-center lg:justify-end mt-8 lg:mt-0">
                <div className="w-full max-w-md bg-white/10 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-white/20">
                  <h3 className="text-xl lg:text-2xl font-bold mb-4 lg:mb-6 text-center">A2992 Quick Facts</h3>
                  <div className="space-y-3 lg:space-y-4">
                    <div className="flex justify-between items-center text-sm lg:text-base">
                      <span className="text-gray-300">Model:</span>
                      <span className="font-semibold text-right">MacBook Pro M3 Max</span>
                    </div>
                    <div className="flex justify-between items-center text-sm lg:text-base">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">MacBook Pro A2992 Compatible Models</h2>
            <p className="text-xl text-muted-foreground">
              Verify your exact MacBook Pro M3 Max 16-inch model before booking repair service
            </p>
          </div>
            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-foreground mb-6 text-center">
                  All A2992 Model Variants Supported
                </h3>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">A2992 XDR Display Specifications</h2>
            <p className="text-xl text-muted-foreground">
              Technical details of your MacBook Pro M3 Max Liquid Retina XDR display
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Common A2992 XDR Display Issues</h2>
            <p className="text-xl text-muted-foreground">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Our A2992 XDR Screen Replacement Process</h2>
            <p className="text-xl text-muted-foreground">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Why Choose MacLap IT Care for A2992?</h2>
            <p className="text-xl text-muted-foreground">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Real experiences from A2992 XDR repair customers
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Common questions about A2992 XDR screen replacement service
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 to-purple-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Fix Your MacBook Pro A2992 XDR Screen?
          </h2>
