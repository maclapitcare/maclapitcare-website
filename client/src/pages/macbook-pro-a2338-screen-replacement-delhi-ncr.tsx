...
export default function MacBookProA2338ScreenReplacementDelhiNCR() {
  ...
  useEffect(() => {
    document.title = "MacBook Pro A2338 Screen Replacement Delhi NCR | M1 2020 | MacLap IT Care";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Professional MacBook Pro A2338 screen replacement service in Delhi NCR. M1 2020 13-inch model repair with warranty. Same-day service available. Call 9211720790");
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              MacBook Pro A2338 Screen Replacement Delhi NCR
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Expert screen replacement service for MacBook Pro M1 13-inch 2020 (A2338) model. Professional repair with genuine parts and 3-month warranty across Delhi NCR locations.
            </p>
            <button
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>• MacBook Pro first M1 model repair</li>
                  <li>• A2338 Retina display replacement</li>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>• A2338 screen replacement price list</li>
                  <li>• MacBook Pro repair cost Delhi</li>
                  <li>• A2338 screen warranty terms</li>
                  <li>• MacBook Pro service charges</li>
                  <li>• A2338 repair estimate cost</li>
                  <li>• MacBook screen replacement quote</li>
                  <li>• A2338 affordable repair options</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">MacBook Pro A2338 Specifications</h2>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-center">
                      ...
                      <strong>Model:</strong> MacBook Pro A2338
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                      <strong>Year:</strong> Late 2020
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                      <strong>Feature:</strong> Touch Bar
                    </li>
                  </ul>
                </div>
      ...
      <ServiceBookingModal 
        ...
        serviceName="MacBook Pro M1 13-inch 2020 (A2338) Screen Replacement"
      />
