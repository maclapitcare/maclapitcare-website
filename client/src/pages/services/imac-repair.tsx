                ...
                <CardContent className="p-4 md:p-6">
                  ...
                  <div className="mt-3 pt-3 border-t border-gray-100">
                    <Button
                      ...
                      variant="outline"
                      className="w-full bg-green-50 hover:bg-green-100 border-green-200 text-green-700 hover:text-green-800 transform hover:scale-105 transition-all duration-200"
                      onClick={() => typeof window !== "undefined" && window.open(`https://wa.me/${CONTACT_INFO.phone1.replace(/\s+/g, '')}?text=Hi! I want iMac repair like ${testimonial.name} got`, '_blank')}
                    >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <Button 
                ...
                onClick={() => typeof window !== "undefined" && (window.location.href = `https://wa.me/919211720790?text=Hi, I need iMac repair service in Delhi NCR`)}
              >
