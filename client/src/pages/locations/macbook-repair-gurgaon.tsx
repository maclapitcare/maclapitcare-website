...
export default function MacBookRepairGurgaon() {
  useEffect(() => {
    document.title = "MacBook Repair Gurgaon Gurugram - Screen, Battery, Logic Board Service | Maclap IT Care";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Expert MacBook repair service in Gurgaon Gurugram. Screen replacement ₹8,999+, battery ₹6,999+, logic board repair ₹12,999+. DLF, Cyber City doorstep service. 4.9/5 rated. Call 9211720790");
    }
  }, []);

  const gurgaonAreas = [
    "DLF Phase 1", "DLF Phase 2", "DLF Phase 3", "DLF Phase 4", "DLF Phase 5",
    "Cyber City", "Golf Course Road", "Sohna Road", "MG Road", "Sector 14",
    "Sector 29", "Sector 31", "Sector 32", "Sector 56", "Udyog Vihar",
    "IFFCO Chowk", "Huda City Centre", "Galleria Market"
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="bg-white/20 text-white mb-4">Gurgaon's #1 MacBook Repair Service</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              MacBook Repair Gurgaon
            </h1>
            <p className="text-xl mb-8 opacity-90">
              Professional MacBook repair service across Gurgaon/Gurugram with doorstep pickup and delivery. 
              Serving DLF, Cyber City, Golf Course Road, and all major sectors.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              MacBook Repair Coverage in Gurgaon
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We provide doorstep MacBook repair services across all areas in Gurgaon/Gurugram
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-br from-slate-50 to-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Why Choose Maclap IT Care for MacBook Repair in Gurgaon?
            </h2>
          </div>
            ...
            {[
              {
                ...
                description: "Free pickup and delivery across Gurgaon NCR"
              },
              {
                icon: Star,
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Get Your MacBook Repaired in Gurgaon Today
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Professional service with doorstep convenience across all Gurgaon locations
          </p>
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
            <a
              href={`tel:+91${CONTACT_INFO.phone1}`}
