        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          <div>
            ...
            <ul className={`space-y-2 text-gray-400 md:block ${openSections.services ? 'block' : 'hidden'}`}>
              ...
              <li><Link href="/macbook-repair-noida-sector-121" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">MacBook Repair Noida</Link></li>
            </ul>
          </div>
