        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
          ...
          <div>
            ...
            <ul className={`space-y-2 text-gray-400 md:block ${openSections.services ? 'block' : 'hidden'}`}>
              <li><Link href="/macbook-repair-service-delhi-ncr" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">MacBook Repair</Link></li>
              <li><Link href="/imac-repair-service-delhi-ncr" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">iMac Repair</Link></li>
              <li><Link href="/mac-mini-repair-service-delhi-ncr" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">Mac Mini Repair</Link></li>
              <li><Link href="/laptop-repair-service-noida-delhi" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">Laptop Repair</Link></li>
              <li><Link href="/gaming-laptop-repair-noida-delhi" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">Gaming Laptop Repair</Link></li>
              <li><Link href="/surface-repair-service-delhi-ncr" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">Surface Repair</Link></li>
              <li><Link href="/macbook-laptop-screen-replacement-noida" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">Screen Replacement</Link></li>
              <li><Link href="/macbook-laptop-battery-replacement-delhi-ncr" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">Battery Replacement</Link></li>
              <li><Link href="/macbook-keyboard-repair-noida-delhi" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">Keyboard Repair</Link></li>
              <li><Link href="/macbook-logic-board-repair-chip-level" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">Logic Board Repair</Link></li>
              <li><Link href="/laptop-data-recovery-service-noida" className="hover:text-primary transition-colors text-sm md:text-base py-1 block">Data Recovery</Link></li>
            </ul>
          </div>
