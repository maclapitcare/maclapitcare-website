...
interface ModelNavigationProps {
  serviceType: 'screen' | 'battery' | 'keyboard' | 'logic-board';
}
        ...
        <div className="text-center mt-12">
          <div className="bg-blue-50 dark:bg-blue-950/20 rounded-xl p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-4">
              ...
              <Button size="lg" variant="outline" onClick={() => window.location.href = 'https://wa.me/919211720790?text=Hi, I need help identifying my MacBook model for repair service'}>
                WhatsApp Us
              </Button>
            </div>
          </div>
