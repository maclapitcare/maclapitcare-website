...
const getModelsForService = (serviceType: string) => {
  const baseModels = [
    ...
    {
      name: "MacBook Air A3240",
      year: "M3 2024",
      size: "13.6-inch",
      color: "from-blue-500 to-purple-500",
      features: ["M3 Chip", "Liquid Retina", "Hardware Ray Tracing"]
    },
    {
    ...
    },
    {
      ...
      features: ["M1 Pro/Max", "Liquid Retina XDR", "ProMotion"]
    },
    {
