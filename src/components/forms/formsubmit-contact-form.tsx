        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <Input
                ...
                className="bg-white text-black border-2 border-gray-200 focus:border-blue-500 transition-colors h-11"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <select 
                ...
                className="w-full px-4 py-3 bg-white text-black border-2 border-gray-200 rounded-md focus:outline-none focus:border-blue-500 transition-colors h-11"
              >
          ...
          <div>
            ...
            <Textarea
              ...
              className="bg-white text-black border-2 border-gray-200 focus:border-blue-500 transition-colors resize-none"
              rows={4}
            />
          </div>
          ...
          <Button 
            ...
            className="w-full bg-green-600 hover:bg-green-700 text-white py-3 text-lg font-semibold shadow-lg transition-all hover:shadow-xl"
          >
