        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Enter your email" {...field} className="bg-white text-black border-gray-300" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} value={field.value || ""}>
                  ...
                  <SelectContent className="bg-white border shadow-lg z-50">
                    <SelectItem value="MacBook" className="hover:bg-gray-100">MacBook</SelectItem>
                    ...
                    <SelectItem value="Surface Pro" className="hover:bg-gray-100">Surface Pro</SelectItem>
                    <SelectItem value="Other Laptop" className="hover:bg-gray-100">Other Laptop</SelectItem>
                  </SelectContent>
                </Select>
                <FormMessage />
              </FormItem>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} value={field.value || ""}>
                  ...
                  <SelectContent className="bg-white border shadow-lg z-50">
                    <SelectItem value="Screen Repair" className="hover:bg-gray-100">Screen Repair</SelectItem>
                    ...
                    <SelectItem value="Logic Board Repair" className="hover:bg-gray-100">Logic Board Repair</SelectItem>
                    <SelectItem value="Trackpad Repair" className="hover:bg-gray-100">Trackpad Repair</SelectItem>
                    <SelectItem value="Touchbar Replacement" className="hover:bg-gray-100">Touchbar Replacement</SelectItem>
                    <SelectItem value="General Repair" className="hover:bg-gray-100">General Repair</SelectItem>
                    <SelectItem value="Diagnosis" className="hover:bg-gray-100">Diagnosis</SelectItem>
                  </SelectContent>
                </Select>
                <FormMessage />
              </FormItem>
