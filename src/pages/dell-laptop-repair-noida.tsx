    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-slate-50">
      ...
      <section className="relative py-16 md:py-24 bg-gradient-to-br from-blue-900 via-slate-900 to-blue-900 text-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-20 items-center min-h-[600px] lg:min-h-[700px]">
            <div className="space-y-4 md:space-y-6 lg:space-y-8 text-center lg:text-left order-2 lg:order-1 max-w-3xl mx-auto lg:mx-0">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 pt-2 md:pt-4 justify-center lg:justify-start">
                <a
                  ...
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg md:rounded-xl font-semibold text-sm md:text-base transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-2xl transform hover:-translate-y-1"
                >
                ...
                <a
                  ...
                  className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-6 md:px-8 py-3 md:py-4 rounded-lg md:rounded-xl font-semibold text-sm md:text-base transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-2xl transform hover:-translate-y-1"
                >
              ...
              {/* Trust Indicators */}
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 pt-4 md:pt-6 w-full">
                <div className="flex items-center space-x-3 p-4 bg-white/5 rounded-lg border border-white/10 min-h-[90px] w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-white text-sm md:text-base leading-tight">Expert Technicians</h4>
                    <p className="text-xs md:text-sm text-gray-300 mt-1">Professional Service</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-4 bg-white/5 rounded-lg border border-white/10 min-h-[90px] w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-white text-sm md:text-base leading-tight">Same Day Service</h4>
                    <p className="text-xs md:text-sm text-gray-300 mt-1">Quick Turnaround</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-4 bg-white/5 rounded-lg border border-white/10 min-h-[90px] w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-white text-sm md:text-base leading-tight">Up to 3 Months Warranty</h4>
                    <p className="text-xs md:text-sm text-gray-300 mt-1">Quality Guarantee</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-4 bg-white/5 rounded-lg border border-white/10 min-h-[90px] w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-semibold text-white text-sm md:text-base leading-tight">5000+ Repairs</h4>
                    <p className="text-xs md:text-sm text-gray-300 mt-1">Experience Counts</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="flex justify-center lg:justify-center xl:justify-end order-1 lg:order-2">
              <div className="relative max-w-sm lg:max-w-md xl:max-w-sm mx-auto lg:mx-0">
                <div className="w-64 h-64 md:w-80 md:h-80 bg-gradient-to-br from-blue-400/20 to-purple-600/20 rounded-full blur-3xl absolute -top-8 -right-8"></div>
                <div className="relative bg-white/10 backdrop-blur-lg rounded-2xl p-6 md:p-8 border border-white/20 max-w-xs w-full">
                  <div className="text-center space-y-4 md:space-y-6">
                    <div className="w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto">
                      <Laptop className="h-8 w-8 md:h-10 md:w-10 text-white" />
                    </div>
                    <h3 className="text-lg md:text-xl font-bold text-white">Dell Repair Expertise</h3>
                    <div className="grid grid-cols-2 gap-3 text-sm">
                      <div className="text-center p-2 bg-white/5 rounded-lg">
                        <div className="font-bold text-blue-400">Inspiron</div>
                        <div className="text-gray-300 text-xs">Series</div>
                      </div>
                      <div className="text-center p-2 bg-white/5 rounded-lg">
                        <div className="font-bold text-green-400">XPS</div>
                        <div className="text-gray-300 text-xs">Premium</div>
                      </div>
                      <div className="text-center p-2 bg-white/5 rounded-lg">
                        <div className="font-bold text-purple-400">Latitude</div>
                        <div className="text-gray-300 text-xs">Business</div>
                      </div>
                      <div className="text-center p-2 bg-white/5 rounded-lg">
                        <div className="font-bold text-red-400">Alienware</div>
                        <div className="text-gray-300 text-xs">Gaming</div>
                      </div>
                    </div>
                  </div>
                </div>
