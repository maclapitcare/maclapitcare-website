...
export default function DellLaptopRepairNoida() {
  ...
  useEffect(() => {
    ...
    keywords.setAttribute('content', 'Dell laptop repair Noida, Inspiron repair, XPS repair, Latitude repair, Alienware repair, Dell screen replacement, Dell overheating fix, Dell motherboard repair, Dell charging port repair, Dell keyboard replacement, Dell data recovery Noida');
  ...
  const commonRepairIssues = [
    ...
    {
      issue: "Dell Data Recovery",
      description: "Professional data recovery service for Dell laptops with damaged storage devices",
      symptoms: ["Hard drive clicking", "Cannot access files", "Blue screen on boot", "Corrupted data", "Deleted files"],
      solution: "Data recovery, backup creation, storage replacement",
      timeframe: "1-5 days",
      icon: HardDrive
    }
  ];
  ...
  const popularSearches = [
    ...
    "Dell data recovery service Noida",
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="space-y-6 md:space-y-8 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm text-white px-4 md:px-6 py-2 md:py-3 rounded-full border border-white/20 text-sm">
                ...
                Dell Authorized Repair Partner
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 md:gap-6 pt-4">
                <a
                  ...
                  className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl md:rounded-2xl font-semibold text-base md:text-lg transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-2xl transform hover:-translate-y-1"
                >
                ...
                <a
                  ...
                  className="bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white px-6 md:px-8 py-3 md:py-4 rounded-xl md:rounded-2xl font-semibold text-base md:text-lg transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-2xl transform hover:-translate-y-1"
                >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 pt-6 md:pt-8">
                <div className="flex items-center space-x-3 md:space-x-4 p-3 md:p-4 bg-white/5 rounded-lg md:rounded-xl border border-white/10">
                  ...
                  <div>
                    <h4 className="font-semibold text-white text-sm md:text-base">Dell Certified</h4>
                    <p className="text-xs md:text-sm text-gray-300">Authorized Service</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 md:space-x-4 p-3 md:p-4 bg-white/5 rounded-lg md:rounded-xl border border-white/10">
                ...
                <div className="flex items-center space-x-3 md:space-x-4 p-3 md:p-4 bg-white/5 rounded-lg md:rounded-xl border border-white/10">
                  ...
                  <div>
                    <h4 className="font-semibold text-white text-sm md:text-base">3 Months Warranty</h4>
              ...
              <Card key={index} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 bg-white border-0 rounded-xl md:rounded-2xl overflow-hidden">
                ...
                <CardContent className="p-6 space-y-6">
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm font-semibold text-gray-900">Starting Prices:</p>
                        <p className="text-xs text-gray-600">{series.priceRange}</p>
                      </div>
                      <Button 
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-8 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-6">
                <a
                  href={`tel:+91${CONTACT_INFO.phone1}`}
                  className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors flex items-center space-x-2 text-lg"
                >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 mb-12">
            {popularSearches.map((search, index) => (
              <div key={index} className="bg-white p-4 rounded-lg border border-gray-200 hover:border-blue-300 transition-colors group cursor-pointer">
