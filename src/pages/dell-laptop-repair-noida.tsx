        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center min-h-[600px]">
            <div className="space-y-4 md:space-y-6 lg:space-y-8 text-center lg:text-left order-2 lg:order-1">
              ...
              {/* Trust Indicators */}
              <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-3 md:gap-4 pt-4 md:pt-6">
                <div className="flex items-center space-x-3 p-3 md:p-4 bg-white/5 rounded-lg border border-white/10 min-h-[80px]">
