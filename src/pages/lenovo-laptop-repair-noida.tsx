...
export default function LenovoLaptopRepairNoida() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute("content", "Expert Lenovo laptop repair in Noida for ThinkPad, IdeaPad, Legion, Yoga, ThinkBook models. Keyboard replacement, motherboard repair, screen replacement. Same day service, 3 months warranty. Call 9211720790");
    }
  ...
  const lenovoModels = [
    {
      ...
      priceRange: "Screen ₹5,200+, Battery ₹3,800+, Keyboard ₹2,200+"
    },
    {
      ...
      priceRange: "Screen ₹3,500+, Battery ₹2,800+, RAM Upgrade ₹2,500+"
    },
    {
      ...
      priceRange: "Screen ₹9,500+, GPU Repair ₹28,000+, Cooling ₹7,500+"
    },
    {
      ...
      priceRange: "Screen ₹8,500+, Hinge ₹6,500+, Touch Panel ₹7,200+"
    },
    {
      ...
      priceRange: "Screen ₹4,500+, Battery ₹3,200+, Motherboard ₹12,500+"
    },
    {
      ...
      priceRange: "Screen ₹3,200+, Battery ₹2,500+, SSD Upgrade ₹3,000+"
    }
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 leading-relaxed">
              Expert Lenovo laptop repair services in Noida Greater Noida. Professional repair for ThinkPad, IdeaPad, Legion, Yoga, ThinkBook models. Keyboard replacement, motherboard repair, screen replacement with same day service and 3 months warranty.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Expert repair services for all Lenovo laptop series with genuine parts, certified technicians, and comprehensive warranty
              </p>
                ...
                <Card key={index} className="hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-blue-50 to-indigo-50 border-l-4 border-blue-600">
                  ...
                  <CardContent>
                    ...
                    <div className="bg-white rounded-lg p-3 mt-4">
                      <div className="text-xs text-blue-600 font-semibold mb-1">Starting Prices:</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <Card className="text-center hover:shadow-xl transition-shadow bg-white">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600">Comprehensive warranty on all Lenovo repair services with quality guarantee</p>
                </CardContent>
              </Card>
