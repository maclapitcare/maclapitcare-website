...
export default function MacBookAirA1466ScreenReplacement() {
  ...
  const compatibleModels = [
    ...
    "EMC 2760 (2014)",
    "EMC 3178 (2017)",
    "MD760 (13-inch, Mid 2013)",
    "MD761 (13-inch, Mid 2013)",
    "MJVE2 (13-inch, Early 2015)",
    "MQD32 (13-inch, Mid 2017)"
  ];

  const screenSpecs = [
    { spec: "Display Size", value: "13.3-inch TN LCD Display" },
    { spec: "Resolution", value: "1440 x 900 pixels (128 PPI)" },
    { spec: "Technology", value: "TN LCD backlit display" },
    { spec: "Color Gamut", value: "Standard sRGB color" },
  ...
  const damageSymptoms = [
    ...
    {
      symptom: "White Screen Display",
      description: "Screen shows only white or blank display",
      severity: "High",
      urgency: "LCD connector or panel failure"
    },
    {
    ...
    {
      symptom: "Dim Backlight",
      description: "Screen appears very dark or backlight not working",
      severity: "Medium",
      urgency: "Backlight inverter or LED failure"
    }
  ];
  ...
  const repairProcess = [
    {
      ...
      description: "Complete A1466 display and system functionality evaluation"
    },
    {
      step: "2", 
      title: "Safe Disassembly",
      description: "Careful removal of A1466 display assembly and components"
    },
    {
      step: "3",
      title: "Display Removal",
      description: "Professional removal of damaged screen from A1466 unit"
    },
    {
      step: "4",
      title: "Quality Component Install",
      description: "Installation of genuine A1466-compatible display assembly"
    },
    {
      step: "5",
    ...
    },
    {
      ...
      description: "Display calibration and color accuracy test"
    }
  ];
  ...
  const whyChooseUs = [
    {
      icon: Award,
      title: "A1466 Specialists",
      description: "Extensive experience with MacBook Air 2013-2017 display replacements"
    },
    {
      icon: Shield,
      title: "Genuine Display Parts",
      description: "OEM-grade 13.3-inch LCD displays with proper backlight"
    },
    {
      icon: Wrench,
    ...
    },
    {
      ...
      description: "Most A1466 screen replacements completed same day"
    },
    {
      icon: Star,
  ...
  const customerReviews = [
    {
      ...
      rating: 5,
      review: "My old MacBook Air 2013 screen was completely cracked. These guys fixed it perfectly in same day. Display looks great and much better than before. Very reasonable price.",
    ...
    },
    {
      ...
      rating: 5,
      review: "Screen went white suddenly. Thought my laptop was dead but they replaced the display and now it's working perfectly. Great service and warranty coverage.",
      device: "MacBook Air 2014"
    },
    {
      name: "Vikash Singh",
      location: "Lajpat Nagar, Delhi",
      rating: 4,
      review: "Had flickering issues for months. MacLap IT Care diagnosed LCD failure and replaced it professionally. Works like new now. Happy with the service quality.",
  ...
  const faqs = [
    {
      ...
      answer: "A1466 is the model number for MacBook Air 13-inch models from 2013-2017. You can find this number on the bottom of your MacBook or in Apple Menu > About This Mac. It includes all Intel-based MacBook Air variants from this period."
    },
    {
      question: "What's included in A1466 screen replacement service?",
      answer: "Our A1466 screen replacement includes genuine display assembly, expert installation, quality testing, and 3-month warranty. We also provide free pickup/delivery across Delhi NCR and same-day service for urgent cases."
    },
    {
      question: "Will the replacement screen work with my older A1466?",
      answer: "Yes, our genuine A1466 display assemblies are compatible with all variants from 2013-2017. The replacement maintains the same 1440x900 resolution and functionality as original."
    },
    {
      question: "How long does A1466 screen replacement take?",
    ...
    },
    {
      ...
      answer: "Yes, we provide up to 3-month comprehensive warranty on A1466 screen replacement including display quality, installation workmanship, and functionality. No questions asked replacement if any issues arise."
    },
    {
      question: "Can you repair A1466 screen damage without full replacement?",
      answer: "For minor backlight issues, partial repair may be possible. However, for cracked LCD or major display failures, complete display assembly replacement is necessary to ensure optimal performance and appearance."
    }
  ];
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-2 mb-6">
                  <Badge className="bg-white/20 text-white text-xs px-3 py-1">A1466 Specialists</Badge>
                ...
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                  ...
                  >
                    ...
                    <span className="relative z-10 text-blue-900 font-semibold">Book A1466 Screen Repair</span>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">MacBook Air A1466 Compatible Models</h2>
            <p className="text-xl text-muted-foreground">
              Verify your exact MacBook Air 2013-2017 model before booking repair service
            </p>
          </div>
            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-foreground mb-6 text-center">
                  All A1466 Model Variants Supported
                </h3>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">A1466 Display Specifications</h2>
            <p className="text-xl text-muted-foreground">
              Technical details of your MacBook Air A1466 display
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Common A1466 Display Issues</h2>
            <p className="text-xl text-muted-foreground">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Our A1466 Screen Replacement Process</h2>
            <p className="text-xl text-muted-foreground">
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Why Choose MacLap IT Care for A1466?</h2>
            <p className="text-xl text-muted-foreground">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Real experiences from A1466 repair customers
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Common questions about A1466 screen replacement service
            </p>
          </div>
