...
export default function MacBookProA2991ScreenReplacement() {
  ...
  useEffect(() => {
    document.title = "MacBook Pro A2991 Display Replacement in Delhi NCR | Best Service | MacLap IT Care";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Expert MacBook Pro A2991 Display Replacement in Delhi NCR. MacLap IT Care offers professional M3 14-inch screen replacement with certified technicians, genuine parts & warranty. Call 9211720790");
    }
  }, []);

  const compatibleModels = [
    "MacBook Pro 14-inch (Late 2023)",
    "MacBook Pro 14-inch M3 (November 2023)",
    "EMC 3929 (2023)",
    "MR7J3 (Space Black, M3, 8GB, 512GB)",
    "MTL73 (Space Gray, M3, 8GB, 1TB)",
    "MR7K3 (Silver, M3, 8GB, 512GB)",
    "MTL83 (Space Black, M3, 8GB, 1TB)",
    "MTXN3 (Space Gray, M3 Pro, 18GB, 512GB)",
    "MTX73 (Silver, M3 Pro, 18GB, 1TB)"
  ];
  ...
  const damageSymptoms = [
    {
      ...
      description: "Visible cracks or damage on premium Mini-LED display",
      severity: "High",
      urgency: "Immediate replacement needed for M3 Pro display"
    },
    {
      symptom: "ProMotion Not Working", 
      description: "120Hz refresh rate not functioning properly",
      severity: "High",
      urgency: "Advanced display controller issue"
    },
    {
      symptom: "Mini-LED Dimming Issues",
      description: "Local dimming zones not working, bright spots or dark areas",
      severity: "High",
    ...
    },
    {
      ...
      severity: "Medium", 
      urgency: "Premium display feature degradation"
    },
    {
  ...
  const repairProcess = [
    {
      ...
      description: "Complete A2991 Liquid Retina XDR and M3 system evaluation"
    },
    {
      step: "2", 
      title: "Precision Disassembly",
      description: "Careful removal of A2991 display assembly and Mini-LED components"
    },
    {
      step: "3",
    ...
    },
    {
      ...
      description: "Installation of genuine A2991 Liquid Retina XDR display"
    },
    {
      step: "5",
    ...
    },
    {
      ...
      description: "ProMotion calibration, HDR verification, Mini-LED zone testing"
    }
  ];
  ...
  const whyChooseUs = [
    {
      icon: Award,
      title: "A2991 XDR Specialists",
      description: "Extensive experience with 2023 MacBook Pro Liquid Retina XDR repairs"
    },
    {
      icon: Shield,
      title: "Genuine XDR Parts",
      description: "OEM-grade Liquid Retina XDR displays with ProMotion compatibility"
    },
    {
      icon: Wrench,
      title: "Expert Installation",
      description: "Certified technicians ensuring perfect Mini-LED functionality"
    },
    {
      icon: Clock,
      title: "Quick Turnaround",
      description: "Most A2991 XDR screen replacements completed same day"
    },
    {
      icon: Star,
    ...
    },
    {
      ...
      description: "Professional service matching premium display technology"
    }
  ];
  ...
  const customerReviews = [
    {
      ...
      rating: 5,
      review: "My MacBook Pro M3 screen was badly cracked. MacLap IT Care replaced it perfectly with original XDR quality. ProMotion and HDR work exactly like before. Excellent service!",
    ...
    },
    {
      ...
      rating: 5,
      review: "Had Mini-LED dimming issues with bright spots. They diagnosed and replaced entire display professionally. Now works perfectly with all HDR content. Great technical expertise.",
      device: "MacBook Pro A2991"
    },
    {
      name: "Vikash Singh",
      location: "Lajpat Nagar, Delhi",
      rating: 4,
      review: "ProMotion stopped working after a drop. MacLap IT Care replaced the display and now 120Hz works perfectly. Professional M3 MacBook Pro repair service.",
  ...
  const faqs = [
    {
      question: "What is MacBook Pro A2991 and how do I identify it?",
      answer: "A2991 is the model number for MacBook Pro 14-inch (Late 2023) with M3 chip - the latest 14-inch MacBook Pro. You can find this number on the bottom of your MacBook or in Apple Menu > About This Mac."
    },
    {
      question: "What's included in A2991 XDR screen replacement service?",
      answer: "Our A2991 screen replacement includes genuine Liquid Retina XDR display assembly, expert installation, quality testing, and 3-month warranty. We also provide free pickup/delivery across Delhi NCR and same-day service for urgent cases."
    },
    {
      question: "Will the replacement screen support ProMotion on my A2991?",
      answer: "Yes, our genuine A2991 Liquid Retina XDR displays fully support ProMotion 120Hz, HDR, Mini-LED local dimming, and all original features. The replacement maintains the same 3024x1964 resolution and 1600 nits peak brightness."
    },
    {
      question: "How long does A2991 XDR screen replacement take?",
      answer: "Most MacBook Pro A2991 screen replacements are completed within 4-6 hours. Same-day service is available for urgent cases. We also offer free pickup and delivery across Delhi NCR."
    },
    {
      question: "Is the A2991 screen replacement covered under warranty?",
      answer: "Yes, we provide up to 3-month comprehensive warranty on A2991 screen replacement including XDR display quality, installation workmanship, and functionality. No questions asked replacement if any issues arise."
    },
    {
      question: "Can you repair A2991 screen damage without full replacement?",
      answer: "For minor software calibration issues, partial repair may be possible. However, for cracked XDR display or major Mini-LED hardware failures, complete display assembly replacement is necessary to maintain optimal performance."
    }
  ];
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="text-center lg:text-left">
                <div className="flex flex-wrap justify-center lg:justify-start items-center gap-2 mb-6">
                  <Badge className="bg-white/20 text-white text-xs px-3 py-1">A2991 XDR Specialists</Badge>
                  <Badge className="bg-white/20 text-white text-xs px-3 py-1">M3 2023 Model</Badge>
                  <Badge className="bg-white/20 text-white text-xs px-3 py-1">Up to 3 Months Warranty</Badge>
                </div>
                <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
                  MacBook Pro A2991<br />
                  <span className="text-blue-200">Display Replacement in Delhi NCR</span>
                </h1>
                <p className="text-xl mb-8 leading-relaxed">
                  MacLap IT Care offers expert MacBook Pro A2991 Display Replacement services. Our certified technicians have the expertise to confidently tackle this job with advance tools and technology. We offer professional replacement process using high-quality screen to provide you that same user experience back.
                </p>
                <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                  ...
                  >
                    ...
                    <span className="relative z-10 text-blue-900 font-semibold">Book A2991 XDR Repair</span>
              ...
              <div className="flex justify-center lg:justify-end mt-8 lg:mt-0">
                <div className="w-full max-w-md bg-white/10 backdrop-blur-sm rounded-2xl p-6 lg:p-8 border border-white/20">
                  <h3 className="text-xl lg:text-2xl font-bold mb-4 lg:mb-6 text-center">A2991 Quick Facts</h3>
                  <div className="space-y-3 lg:space-y-4">
                    <div className="flex justify-between items-center text-sm lg:text-base">
                      <span className="text-gray-300">Model:</span>
                      <span className="font-semibold text-right">MacBook Pro M3 2023</span>
                    </div>
                    <div className="flex justify-between items-center text-sm lg:text-base">
            ...
            <Card className="border-blue-200 shadow-lg">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold text-foreground mb-4">MacLap IT Care A2991 Service Details</h2>
                  <p className="text-xl text-muted-foreground">
                    Comprehensive information about our MacBook Pro M3 screen replacement service
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <ul className="space-y-2 text-muted-foreground">
                      <li className="flex items-start">
                        ...
                        <span>Genuine A2991 Liquid Retina XDR displays only</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-1 flex-shrink-0" />
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-1 flex-shrink-0" />
                        <span>HDR content display verification</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-muted-foreground">
                      ...
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-1 flex-shrink-0" />
                        <span>XDR replacement completed 4-6 hours</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-1 flex-shrink-0" />
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">MacBook Pro A2991 Compatible Models</h2>
            <p className="text-xl text-muted-foreground">
              Verify your exact MacBook Pro M3 2023 model before booking repair service
            </p>
          </div>
            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-foreground mb-6 text-center">
                  All A2991 Model Variants Supported
                </h3>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">A2991 Liquid Retina XDR Specifications</h2>
            <p className="text-xl text-muted-foreground">
              Technical details of your M3 MacBook Pro premium display
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Common A2991 XDR Display Issues</h2>
            <p className="text-xl text-muted-foreground">
              Identify symptoms that indicate Liquid Retina XDR replacement is needed
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Our A2991 XDR Replacement Process</h2>
            <p className="text-xl text-muted-foreground">
              Professional 6-step process ensuring quality Liquid Retina XDR results
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Why Choose MacLap IT Care for A2991?</h2>
            <p className="text-xl text-muted-foreground">
              Delhi NCR's trusted MacBook Pro M3 2023 repair specialists
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Real experiences from A2991 M3 2023 repair customers
            </p>
          </div>
            ...
            <Card className="border-blue-200 shadow-lg">
              <CardContent className="p-8">
                <div className="text-center mb-8">
                  <h2 className="text-3xl font-bold text-foreground mb-4">MacLap IT Care A2991 Service Details</h2>
                  <p className="text-xl text-muted-foreground">
                    Comprehensive information about our MacBook Pro M3 XDR screen replacement service
                  </p>
                </div>
                
                <div className="mb-8">
                  <h3 className="text-2xl font-bold text-foreground mb-4">
                    Expert MacBook Pro M3 A2991 Display Replacement Service in Delhi NCR
                  </h3>
                  <p className="text-muted-foreground mb-4">
                    The MacLap IT Care technicians are highly trained and experienced in working with Apple products, 
                    especially the advanced M3 MacBook Pro models. Our expertise in A2991 Liquid Retina XDR replacement 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <h3 className="text-2xl font-bold text-foreground mb-4">
                      Get Up to 3 Month Warranty on MacBook Pro A2991 Screen Replacement
                    </h3>
                    <p className="text-muted-foreground mb-6">
                      We provide rock-solid assurance at MacLap IT Care's MacBook Pro M3 XDR screen replacement service. 
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">Common Customer Searches for A2991 M3 XDR Screen Issues</h2>
            <p className="text-xl text-muted-foreground">
              Popular search terms customers use when looking for MacBook Pro M3 XDR screen replacement
            </p>
          </div>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li>• a2991 liquid retina xdr broken fix</li>
                    <li>• macbook pro 2023 screen replacement cost</li>
                    <li>• m3 macbook pro black screen</li>
                    <li>• macbook pro xdr screen flickering</li>
                    <li>• a2991 display replacement near me</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li>• a2991 display replacement noida</li>
                    <li>• macbook m3 xdr screen gurgaon</li>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li>• a2991 display color distortion</li>
                    <li>• macbook pro backlight not working</li>
                    <li>• m3 macbook pro dead pixels</li>
                    <li>• macbook pro xdr screen dim</li>
                    <li>• a2991 promotion display issues</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li>• genuine vs duplicate xdr screen</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
              ...
              <Card className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-blue-950/20 dark:via-indigo-950/20 dark:to-purple-950/20 border-blue-200 dark:border-blue-800">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground mb-6">
                    ...
                    we understand exactly what MacBook Pro A2991 M3 XDR users need when their screen gets damaged.
                  </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">MacBook Pro A2991 FAQ</h2>
            <p className="text-xl text-muted-foreground">
              Common questions about MacBook Pro M3 2023 XDR screen replacement
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-bold text-foreground mb-2">How much does A2991 XDR screen replacement cost?</h3>
                <p className="text-muted-foreground">MacBook Pro A2991 Liquid Retina XDR screen replacement typically costs between ₹35,000-45,000 depending on display quality and service location in Delhi NCR.</p>
              </CardContent>
            </Card>
            
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-bold text-foreground mb-2">How long does M3 MacBook Pro XDR screen repair take?</h3>
                <p className="text-muted-foreground">Standard A2991 XDR screen replacement takes 6-8 hours. We offer same-day service for urgent repairs in Delhi NCR area.</p>
              </CardContent>
            </Card>
            
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-bold text-foreground mb-2">Is A2991 screen compatible with other MacBook models?</h3>
                <p className="text-muted-foreground">No, A2991 uses specific M3-compatible Liquid Retina XDR display. Only use genuine A2991 replacement screens for proper functionality.</p>
              </CardContent>
            </Card>
            
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-bold text-foreground mb-2">Do you provide warranty on A2991 XDR screen replacement?</h3>
                <p className="text-muted-foreground">Yes, MacLap IT Care provides up to 3 months warranty on A2991 XDR screen replacement including parts and workmanship.</p>
              </CardContent>
            </Card>
            
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-bold text-foreground mb-2">Can you fix A2991 XDR display issues and dead pixels?</h3>
                <p className="text-muted-foreground">Yes, we fix all A2991 XDR display problems including ProMotion issues, color distortion, backlight problems, and dead pixels.</p>
              </CardContent>
            </Card>
            
            <Card>
              <CardContent className="p-6">
                <h3 className="text-lg font-bold text-foreground mb-2">Do you offer pickup and delivery for A2991 repair?</h3>
                <p className="text-muted-foreground">Yes, we provide free pickup and delivery service across Delhi NCR for A2991 MacBook Pro XDR screen replacement.</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Ready to Fix Your MacBook Pro A2991 XDR Screen?
            </h2>
            <p className="text-xl mb-8 opacity-90">
              Professional screen replacement for MacBook Pro M3 2023 with Liquid Retina XDR technology and 3-month warranty
            </p>
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
              <Button 
                size="lg" 
              ...
              <Button 
                ...
                onClick={() => window.location.href = `https://wa.me/${CONTACT_INFO.phone2}?text=Hi, I need MacBook Pro A2991 XDR screen replacement service`}
              >
