  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>• A2485 screen lines issue</li>
                  <li>• MacBook Pro dim screen repair</li>
                  <li>• A2485 backlight not working</li>
                  <li>• MacBook Pro display not working</li>
                  <li>• A2485 Touch Bar screen issue</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>• MacBook Pro second M2 model repair</li>
                  <li>• A2485 Retina display replacement</li>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>• A2485 screen replacement price list</li>
                  <li>• MacBook Pro M2 repair cost Delhi</li>
                  <li>• A2485 screen warranty terms</li>
                  <li>• MacBook Pro service charges</li>
                  <li>• A2485 repair estimate cost</li>
                  <li>• MacBook screen replacement quote</li>
                  <li>• A2485 affordable repair options</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">MacBook Pro A2485 Specifications</h2>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-center">
                      ...
                      <strong>Model:</strong> MacBook Pro A2485
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                      <strong>Year:</strong> Mid 2022
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
      ...
      <ServiceBookingModal 
        ...
        serviceName="MacBook Pro M2 13-inch 2022 (A2485) Screen Replacement"
      />
