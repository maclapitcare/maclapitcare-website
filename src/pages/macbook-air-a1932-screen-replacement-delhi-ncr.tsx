...
export default function MacBookAirA1932ScreenReplacementDelhiNCR() {
  ...
  useEffect(() => {
    document.title = "MacBook Air A1932 Screen Replacement Delhi NCR | 13-inch Retina 2018-2019 | MacLap IT Care";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Professional MacBook Air A1932 screen replacement service in Delhi NCR. 13-inch Retina 2018-2019 model repair with warranty. Same-day service available. Call 9211720790");
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Expert screen replacement service for MacBook Air 13-inch Retina 2018-2019 (A1932) model. Professional repair with genuine parts and 3-month warranty across Delhi NCR locations.
            </p>
            <button
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>• A1932 cracked screen repair Delhi</li>
                  ...
                  <li>• MacBook Air Retina screen repair</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>• A1932 Touch ID repair</li>
                  <li>• MacBook Air butterfly keyboard repair</li>
                  <li>• A1932 compatible screen parts</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>• A1932 screen replacement price list</li>
                  <li>• MacBook Air Retina repair cost Delhi</li>
                  <li>• A1932 screen warranty terms</li>
                  <li>• MacBook Air 2018 service charges</li>
                  <li>• A1932 repair estimate cost</li>
                  <li>• MacBook screen replacement quote</li>
                  <li>• A1932 affordable repair options</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">MacBook Air A1932 Specifications</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-center">
                      ...
                      <strong>Model:</strong> MacBook Air A1932
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                      <strong>Year:</strong> Late 2018 - Mid 2019
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                      <strong>Processor:</strong> Intel Core i5 8th gen
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                      <strong>Feature:</strong> Touch ID, First Retina Air
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-700">
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                      First-generation Retina Air issues
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                      Butterfly keyboard flex cable problems
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-red-500 rounded-full mr-3"></span>
                      True Tone calibration issues
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <ServiceBookingModal 
        ...
        serviceName="MacBook Air 13-inch Retina 2018-2019 (A1932) Screen Replacement"
      />
