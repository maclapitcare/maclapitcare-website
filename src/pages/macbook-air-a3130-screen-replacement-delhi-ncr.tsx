...
export default function MacBookAirA3130ScreenReplacementDelhiNCR() {
  ...
  useEffect(() => {
    document.title = "MacBook Air A3130 Screen Replacement Delhi NCR | 15-inch M2 2023 | MacLap IT Care";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Professional MacBook Air A3130 screen replacement service in Delhi NCR. 15-inch M2 2023 model repair with warranty. Same-day service available. Call 9211720790");
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              MacBook Air A3130 Screen Replacement Delhi NCR
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Expert screen replacement service for MacBook Air 15-inch M2 2023 (A3130) model. Professional repair with genuine parts and 3-month warranty across Delhi NCR locations.
            </p>
            <button
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>• A3130 screen replacement price list</li>
                  <li>• MacBook Air 15-inch repair cost Delhi</li>
                  <li>• A3130 screen warranty terms</li>
                  <li>• MacBook Air 2023 service charges</li>
                  <li>• A3130 repair estimate cost</li>
                  <li>• MacBook screen replacement quote</li>
                  <li>• A3130 affordable repair options</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">MacBook Air A3130 Specifications</h2>
                ...
                <div>
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-center">
                      ...
                      <strong>Model:</strong> MacBook Air A3130
                    </li>
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                    ...
                    <li className="flex items-center">
                      <span className="w-2 h-2 bg-blue-600 rounded-full mr-3"></span>
                      <strong>Feature:</strong> Largest MacBook Air ever
                    </li>
                  </ul>
                </div>
      ...
      <ServiceBookingModal 
        ...
        serviceName="MacBook Air 15-inch M2 2023 (A3130) Screen Replacement"
      />
