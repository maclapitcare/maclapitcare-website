  ...
  const handleHeroFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const formSubmitData = {
        ...
        device: "MacBook/Laptop Battery Replacement",
        service: "Battery Replacement",
        message: "Battery replacement request from Delhi NCR page",
        _subject: "New Battery Replacement Request - MacLap IT Care",
        _captcha: "false"
      };
