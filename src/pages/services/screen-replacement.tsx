          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
              <Button 
                ...
                onClick={() => typeof window !== "undefined" && (if(typeof window !== "undefined") { window.location.href = `tel:${CONTACT_INFO.phone1; }}`}
              >
              ...
              <Button 
                ...
                onClick={() => typeof window !== "undefined" && (if(typeof window !== "undefined") { window.location.href = '/contact'; }}
              >
