...
export default function MacBookAirScreenReplacement() {
  ...
  useEffect(() => {
    document.title = "MacBook Air Screen Replacement Service | Expert Retina Display Repair Delhi NCR | Maclap IT Care";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Professional MacBook Air screen replacement service in Delhi NCR. Original Retina displays, same-day service, 3-month warranty. All MacBook Air models 2018-2024. Free diagnosis & pickup. Expert technicians.");
    }
    ...
    const setKeywordsTag = () => {
      ...
      keywordsMeta.setAttribute('content', 'MacBook Air screen replacement, MacBook Air Retina display repair, MacBook Air screen repair Delhi, Apple MacBook Air display service, MacBook Air repair Noida, MacBook Air screen replacement Gurgaon, MacBook Air service center, MacBook Air display repair');
    };
    setKeywordsTag();
  }, []);
  ...
  const faqs = [
    {
      ...
      answer: "MacBook Air screen replacement costs vary based on your specific model, damage type, and required parts. We provide transparent quotes after free diagnosis with no hidden charges. Contact us for a personalized quote that's competitive and honest."
    },
    {
    ...
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Get Personalized Quote for Your MacBook Air
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Tell us about your MacBook Air model and screen damage. We'll provide a transparent, competitive quote with no hidden charges.
            </p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <Card className="p-8">
                <CardHeader className="text-center pb-6">
                  ...
                  <p className="text-muted-foreground">Get instant quote for your MacBook Air screen replacement</p>
                </CardHeader>
                <CardContent>
                  <form className="space-y-6">
                    <div>
                      <label className="block text-sm font-medium mb-2">MacBook Air Model</label>
                      <Select onValueChange={setSelectedModel}>
                        <SelectTrigger>
                          <SelectValue placeholder="Select your MacBook Air model" />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div>
                      ...
                      <Select>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="dead-pixels">Dead Pixels</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
              ...
              <div className="space-y-6">
                <Card className="p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5" />
                      <div>
                        <p className="font-medium">Ultra-Thin Expertise</p>
                        <p className="text-sm text-muted-foreground">Specialized tools for MacBook Air's thin design</p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-green-500 mt-0.5" />
                ...
                <Card className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <a
                      href={`https://wa.me/91${CONTACT_INFO.phone1}?text=Hi%2C%20I%20need%20MacBook%20Air%20screen%20replacement%20quote`}
                      target="_blank"
                      rel="noopener noreferrer"
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
              Our Professional MacBook Air Repair Process
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From diagnosis to delivery, we follow a systematic process to ensure your MacBook Air screen replacement is perfect
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Complete assessment of your MacBook Air screen damage. We test display functionality and check for other issues.
                  </p>
              ...
              <div className="text-center">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Detailed breakdown of repair costs including parts, labor, and warranty. No hidden charges - everything explained clearly.
                  </p>
              ...
              <div className="text-center">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Skilled technicians perform screen replacement using specialized tools for MacBook Air's ultra-thin design.
                  </p>
