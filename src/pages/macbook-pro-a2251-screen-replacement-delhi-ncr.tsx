...
export default function MacBookProA2251ScreenReplacementDelhiNCR() {
  ...
  useEffect(() => {
    document.title = "MacBook Pro A2251 Screen Replacement Delhi NCR | 13-inch Touch Bar Intel 2020 | MacLap IT Care";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Professional MacBook Pro A2251 screen replacement service in Delhi NCR. 13-inch Touch Bar Intel 2020 model repair with warranty. Same-day service available. Call 9211720790");
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Expert screen replacement service for MacBook Pro 13-inch Touch Bar Intel 2020 (A2251) model. Professional repair with genuine parts and 3-month warranty across Delhi NCR locations.
            </p>
            <button
              onClick={() => setIsBookingModalOpen(true)}
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibent py-4 px-8 rounded-lg text-lg transition-colors"
            >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>• MacBook Pro 13 inch 2020 Intel display replacement</li>
                  <li>• A2251 4-port Thunderbolt screen repair</li>
                  <li>• MacBook Pro final Intel screen repair</li>
                  <li>• A2251 display assembly replacement</li>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>• MacBook Pro Intel 2020 repair shop</li>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>• MacBook Pro final Intel flickering display</li>
                  <li>• A2251 screen lines issue</li>
                  <li>• MacBook Pro dim screen repair</li>
                  <li>• A2251 4-port Thunderbolt issues</li>
                  <li>• MacBook Pro display not working</li>
                  <li>• A2251 Magic Keyboard screen calibration</li>
                </ul>
              </div>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  ...
                  <li>• MacBook Pro final Intel 2020 service</li>
                  <li>• A2251 screen original replacement</li>
                  <li>• MacBook Pro 10th generation Intel</li>
                  <li>• A2251 4-port model repair</li>
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li>• A2251 screen replacement price list</li>
                  <li>• MacBook Pro Intel 2020 repair cost Delhi</li>
                  <li>• A2251 screen warranty terms</li>
                  <li>• MacBook Pro final Intel service charges</li>
                  <li>• A2251 repair estimate cost</li>
                  <li>• MacBook screen replacement quote</li>
                  <li>• A2251 affordable repair options</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <ServiceBookingModal 
        ...
        serviceName="MacBook Pro 13-inch Touch Bar Intel 2020 (A2251) Screen Replacement"
      />
