...
export default function Noida() {
  ...
  useEffect(() => {
    document.title = "MacBook Repair Noida Greater Noida | MacBook Pro Air Screen Battery Logic Board Repair Near Me | Maclap IT Care";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Expert MacBook repair in Noida & Greater Noida. MacBook Pro & Air screen replacement ₹4999+, battery ₹3999+, Logic Board ₹1499+. Apple Silicon M1/M2/M3 specialists. Free doorstep pickup all sectors. Call +91 92117 20790");
    }
  }, []);
  ...
  return (
    <div>
      ...
      {/* We Cover All Areas in Noida & Greater Noida */}
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-4">We Cover All Areas in Noida & Greater Noida</h2>
            <p className="text-xl text-muted-foreground">
              Professional MacBook repair services across all sectors with free doorstep pickup & delivery
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            {[
              { name: "MacBook Repair Sector 18 Noida", url: "/macbook-repair-sector-18-noida" },
              { name: "MacBook Repair Sector 62 Noida", url: "/macbook-repair-sector-62-noida" }, 
              { name: "MacBook Repair Sector 132 Noida", url: "/macbook-repair-sector-132-noida" },
              { name: "MacBook Repair Knowledge Park Greater Noida", url: "/macbook-repair-knowledge-park-greater-noida" },
              { name: "MacBook Repair Sector 137 Noida", url: "/macbook-repair-sector-137-noida" },
              { name: "MacBook Repair Sector 128 Noida", url: "/macbook-repair-sector-128-noida" },
              { name: "MacBook Repair Sector 150 Noida", url: "/macbook-repair-sector-150-noida" },
              { name: "MacBook Repair Greater Noida West", url: "/macbook-repair-greater-noida-west" },
              { name: "MacBook Repair Sector 75 Noida", url: "/macbook-repair-sector-75-noida" },
              { name: "MacBook Repair Sector 94 Noida", url: "/macbook-repair-sector-94-noida" },
              { name: "MacBook Repair Sector 129 Noida", url: "/macbook-repair-sector-129-noida" },
              { name: "MacBook Repair Techzone 4 Greater Noida", url: "/macbook-repair-techzone-4-greater-noida" },
              { name: "MacBook Repair Sector 142 Noida", url: "/macbook-repair-sector-142-noida" },
              { name: "MacBook Repair Sector 90 Noida", url: "/macbook-repair-sector-90-noida" },
              { name: "MacBook Repair Sector 36 Greater Noida", url: "/macbook-repair-sector-36-greater-noida" },
              { name: "MacBook Repair Sector 72 Noida", url: "/macbook-repair-sector-72-noida" },
              { name: "MacBook Repair Sector 110 Noida", url: "/macbook-repair-sector-110-noida" },
              { name: "MacBook Repair Pari Chowk Greater Noida", url: "/macbook-repair-pari-chowk-greater-noida" },
              { name: "MacBook Repair Sector 1 Greater Noida", url: "/macbook-repair-sector-1-greater-noida" },
              { name: "MacBook Repair Sector 16B Greater Noida", url: "/macbook-repair-sector-16b-greater-noida" },
              { name: "MacBook Repair Sector 121 Noida", url: "/macbook-repair-sector-121-noida" },
              { name: "MacBook Repair Sector 125 Noida", url: "/macbook-repair-sector-125-noida" },
              { name: "MacBook Repair Sector 15 Noida", url: "/macbook-repair-sector-15-noida" },
              { name: "MacBook Repair Sector 16 Noida", url: "/macbook-repair-sector-16-noida" },
              { name: "MacBook Repair Sector 41 Noida", url: "/macbook-repair-sector-41-noida" },
              { name: "MacBook Repair Sector 44 Noida", url: "/macbook-repair-sector-44-noida" },
              { name: "MacBook Repair Sector 45 Noida", url: "/macbook-repair-sector-45-noida" },
              { name: "MacBook Repair Sector 61 Noida", url: "/macbook-repair-sector-61-noida" },
              { name: "MacBook Repair Sector 63 Noida", url: "/macbook-repair-sector-63-noida" },
              { name: "MacBook Repair Sector 104 Noida", url: "/macbook-repair-sector-104-noida" },
              { name: "MacBook Repair Sector 135 Noida", url: "/macbook-repair-sector-135-noida" },
              { name: "MacBook Repair Noida Extension", url: "/macbook-repair-noida-extension" },
              { name: "MacBook Repair Alpha Commercial Belt", url: "/macbook-repair-alpha-commercial-belt" },
              { name: "MacBook Repair Film City Greater Noida", url: "/macbook-repair-film-city-greater-noida" }
            ].map((area, index) => (
              <a key={index} href={area.url} className="block">
                <div className="bg-white p-4 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow border border-gray-100 hover:border-blue-300 cursor-pointer">
          ...
          <div className="text-center mt-12">
            <p className="text-muted-foreground mb-4">
              Same day repair service • Free pickup & delivery • Expert technicians • 6 month warranty
            </p>
            <Button 
