...
import { CheckCircle, MapPin, Clock, Shield, Phone, Star, Monitor, Battery, Keyboard, Cpu, Wrench, HardDrive, ArrowRight } from "lucide-react";
...
export default function LaptopRepairNoidaGreaterNoida() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      {/* Expert Laptop Repair Services by Brand */}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {laptopBrands.map((brand, index) => {
              // Special handling for Dell card to make it clickable
              if (brand.name === "Dell Laptop Repair") {
                return (
                  <Link key={index} href="/dell-laptop-repair-noida">
                    <Card className="hover:shadow-lg transition-all bg-white border-2 hover:border-blue-200 cursor-pointer hover:border-blue-400 hover:-translate-y-1 transform duration-300 h-full">
                      <CardHeader className="text-center pb-3">
                        <div className="relative">
                          <brand.icon className="h-12 w-12 text-blue-600 mx-auto mb-3" />
                          <ArrowRight className="absolute top-0 right-0 h-4 w-4 text-blue-600" />
                        </div>
                        <CardTitle className="text-lg text-blue-700">Dell Laptop Repair in Noida</CardTitle>
                      </CardHeader>
                      <CardContent className="text-center">
                        <div className="mb-4">
                          <h4 className="font-semibold text-sm text-gray-900 mb-2">MODELS COVERED:</h4>
                        ...
                        <div className="mb-4">
                          ...
                          <p className="text-xs text-muted-foreground">{brand.specialties}</p>
                        </div>
              ...
              // Regular cards for other brands
              return (
                <Card key={index} className="hover:shadow-lg transition-all bg-white border-2 hover:border-blue-200 h-full">
                  <CardHeader className="text-center pb-3">
                    <div className="relative">
                      <brand.icon className="h-12 w-12 text-blue-600 mx-auto mb-3" />
                    </div>
                    <CardTitle className="text-lg text-blue-700">{brand.name} in Noida</CardTitle>
                  </CardHeader>
                  <CardContent className="text-center">
                    <div className="mb-4">
                      <h4 className="font-semibold text-sm text-gray-900 mb-2">MODELS COVERED:</h4>
            ...
            {[
              {
                ...
                features: ["Screen replacement", "Overheating solutions", "Motherboard repair", "Hinge repair & replacement"],
                link: "/dell-laptop-repair-noida"
              },
              {
              ...
              const CardComponent = ({ children }: { children: React.ReactNode }) => {
                if (brand.link) {
                  return (
                    <Link href={brand.link}>
                      <Card className="hover:shadow-lg transition-shadow bg-white border-2 hover:border-blue-200 cursor-pointer hover:border-blue-400 hover:-translate-y-1 transform duration-300">
                        {children}
                      </Card>
                    </Link>
                  );
                ...
                return (
                  <Card className="hover:shadow-lg transition-shadow bg-white border-2 hover:border-blue-200">
                    {children}
                  </Card>
                );
              };
                ...
                <CardComponent key={index}>
                  <CardHeader className="text-center pb-3">
                    <div className="relative">
                      <brand.icon className="h-12 w-12 text-blue-600 mx-auto mb-3" />
                      {brand.link && (
                        <ArrowRight className="absolute top-0 right-0 h-4 w-4 text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity" />
                      )}
                    </div>
