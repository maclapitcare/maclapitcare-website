...
export default function MacBookRepairDelhi() {
  useEffect(() => {
    document.title = "MacBook Repair Delhi - Screen, Battery, Logic Board Repair Service | Maclap IT Care";
    
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Professional MacBook repair service in Delhi. Screen replacement ₹8,999+, battery ₹6,999+, logic board repair ₹12,999+. Doorstep pickup/delivery. 4.9/5 rated. Same-day service. Call 9211720790");
    }
  }, []);
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="bg-white/20 text-white mb-4">Delhi's #1 MacBook Repair Service</Badge>
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              MacBook Repair Delhi
            </h1>
            <p className="text-xl mb-8 opacity-90">
              Professional MacBook repair service across Delhi with doorstep pickup and delivery. 
