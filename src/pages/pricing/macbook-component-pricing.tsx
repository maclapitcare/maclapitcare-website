          ...
          <div className="text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-6">
              ...
              <button
                ...
                onClick={() => typeof window !== "undefined" && (window.location.href = `https://wa.me/91${CONTACT_INFO.phone1}?text=Hi, I need MacBook repair quote`)}
              >
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-8 border border-blue-100">
                <div className="text-center mb-6">
                  <h4 className="text-2xl font-bold text-gray-900 mb-2">Get Instant Quote</h4>
                  <p className="text-gray-600">Tell us about your MacBook and get competitive pricing</p>
                </div>
                
                <form
                  action={`https://formsubmit.co/maclapitcare@gmail.com`}
                  method="POST"
                  className="space-y-4"
                >
                  {/* Hidden FormSubmit.co configuration */}
                  <input type="hidden" name="_subject" value="New MacBook Repair Quote Request - Pricing Page" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">MacBook Model</label>
                      <select
                        name="device"
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      >
                        ...
                        <option value="MacBook Pro 14 M1 (2021)">MacBook Pro 14" M1 Pro/Max (2021)</option>
                        <option value="MacBook Pro 14 M2 (2023)">MacBook Pro 14" M2 Pro/Max (2023)</option>
                        <option value="MacBook Pro 16 M1 (2021)">MacBook Pro 16" M1 Pro/Max (2021)</option>
                        <option value="MacBook Pro 16 M2 (2023)">MacBook Pro 16" M2 Pro/Max (2023)</option>
                        <option value="MacBook Air 13 Intel (2017-2020)">MacBook Air 13" Intel (2017-2020)</option>
                        <option value="MacBook Pro 13 Intel (2016-2020)">MacBook Pro 13" Intel (2016-2020)</option>
                        <option value="MacBook Pro 15 Intel (2016-2019)">MacBook Pro 15" Intel (2016-2019)</option>
                        <option value="MacBook Pro 16 Intel (2019)">MacBook Pro 16" Intel (2019)</option>
                        <option value="Other MacBook Model">Other MacBook Model</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-sm font-semibold text-gray-700 mb-2">Repair Needed</label>
                      <select
                        name="service"
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      >
                        ...
                        <option value="Free Diagnosis">Free Diagnosis</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <Textarea
                      name="message"
                      placeholder="Describe the problem with your MacBook (e.g., cracked screen, battery not charging, keys not working, etc.)"
                      rows={3}
                      className="w-full"
                    />
                  </div>
                  ...
                  <div className="pt-4">
                    ...
                    <p className="text-xs text-gray-500 text-center mt-2">
                      We'll respond within 15 minutes with competitive pricing
                    </p>
                  </div>
                </form>
              </div>
