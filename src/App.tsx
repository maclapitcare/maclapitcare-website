...
import MacBookModelSelection from "./pages/macbook-model-selection";
...
// Brand-Specific Laptop Repair Pages
import DellLaptopRepairNoida from "./pages/dell-laptop-repair-noida";
import HPLaptopRepairNoida from "./pages/hp-laptop-repair-noida";
import LenovoLaptopRepairNoida from "./pages/lenovo-laptop-repair-noida";
import ASUSLaptopRepairNoida from "./pages/asus-laptop-repair-noida";
import MSILaptopRepairNoida from "./pages/msi-laptop-repair-noida";
import AcerLaptopRepairNoida from "./pages/acer-laptop-repair-noida";

// Laptop Repair Pages
import LaptopRepairGhaziabadVaishaliIndirapuram from "./pages/locations/laptop-repair-ghaziabad-vaishali-indirapuram";
import LaptopRepairGurgaonGurugram from "./pages/locations/laptop-repair-gurgaon-gurugram";
import LaptopRepairDelhiDoorstepService from "./pages/locations/laptop-repair-delhi-doorstep-service";
import LaptopRepairNoidaGreaterNoida from "./pages/locations/laptop-repair-noida-greater-noida";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <Suspense fallback={<div className="flex items-center justify-center min-h-96">
          ...
          {/* Model Selection */}
          <Route path="/select-macbook-model-repair" component={MacBookModelSelection} />
          
          {/* SEO-Optimized Service URLs */}
          <Route path="/macbook-repair-service-delhi-ncr" component={MacBookRepair} />
          <Route path="/laptop-repair-service-noida-delhi" component={LaptopRepairNoidaGreaterNoida} />
          ...
          <Route path="/laptop-repair-delhi-doorstep-service" component={LaptopRepairDelhiDoorstepService} />
          <Route path="/macbook-repair-noida-greater-noida" component={Noida} />
          <Route path="/laptop-repair-noida-greater-noida" component={LaptopRepairNoidaGreaterNoida} />
          <Route path="/laptop-repair-gurgaon-gurugram" component={LaptopRepairGurgaonGurugram} />
          <Route path="/laptop-repair-ghaziabad-vaishali-indirapuram" component={LaptopRepairGhaziabadVaishaliIndirapuram} />
          
          {/* Brand-Specific Laptop Repair Pages */}
          <Route path="/dell-laptop-repair-noida" component={DellLaptopRepairNoida} />
          <Route path="/hp-laptop-repair-noida" component={HPLaptopRepairNoida} />
          <Route path="/lenovo-laptop-repair-noida" component={LenovoLaptopRepairNoida} />
          <Route path="/asus-laptop-repair-noida" component={ASUSLaptopRepairNoida} />
          <Route path="/msi-laptop-repair-noida" component={MSILaptopRepairNoida} />
          <Route path="/acer-laptop-repair-noida" component={AcerLaptopRepairNoida} />
