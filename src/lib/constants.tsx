import { 
  ...
  MousePointer, Wifi, Usb, Zap, Shield, Camera, Mic, Power, RefreshCcw, 
  MemoryStick, Gamepad2, Settings, CircuitBoard
} from "lucide-react";
...
export const SERVICES = [
  ...
  { name: "Screen Replacement", path: "/macbook-laptop-screen-replacement-noida", icon: Monitor },
  { name: "Battery Replacement", path: "/macbook-laptop-battery-replacement-delhi-ncr", icon: Battery },
  { name: "Keyboard Repair", path: "/macbook-keyboard-repair-noida-delhi", icon: Keyboard },
  { name: "Logic Board Repair", path: "/macbook-logic-board-repair-chip-level", icon: Cpu },
  { name: "Data Recovery", path: "/laptop-data-recovery-service-noida", icon: HardDrive },
  ...
  { name: "Mac Mini Repair", path: "/mac-mini-repair-service-delhi-ncr", icon: Apple },
  { name: "Gaming Laptop Repair", path: "/gaming-laptop-repair-noida-delhi", icon: Gamepad2 },
  { name: "Surface Repair", path: "/surface-repair-service-delhi-ncr", icon: Laptop },
];

export const SPECIALIZED_SERVICES = [
  { name: "Screen Repair", icon: Monitor, path: "/macbook-laptop-screen-replacement-noida" },
  { name: "Battery", icon: Battery, path: "/macbook-laptop-battery-replacement-delhi-ncr" },
  { name: "Keyboard", icon: Keyboard, path: "/macbook-keyboard-repair-noida-delhi" },
  { name: "Logic Board", icon: Cpu, path: "/macbook-logic-board-repair-chip-level" },
  { name: "Data Recovery", icon: HardDrive, path: "/laptop-data-recovery-service-noida" },
  { name: "Speaker", icon: Volume2 },
  { name: "Cooling", icon: Fan },
  { name: "Trackpad", icon: MousePointer },
  { name: "WiFi Repair", icon: Wifi },
  { name: "USB Port", icon: Usb },
  { name: "Performance", icon: Zap },
  { name: "Virus Removal", icon: Shield },
  { name: "Camera", icon: Camera },
  { name: "Microphone", icon: Mic },
  { name: "Power Jack", icon: Power },
  { name: "System Restore", icon: RefreshCcw },
  { name: "Memory Upgrade", icon: MemoryStick },
  { name: "Gaming Optimize", icon: Gamepad2 },
  { name: "Diagnosis", icon: Settings },
