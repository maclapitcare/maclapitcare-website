      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-4 max-w-4xl mx-auto">
              <p className="text-sm text-blue-700 dark:text-blue-300">
                <strong>All {macBookProModels.reduce((total, category) => total + category.models.length, 0)} MacBook Pro models covered</strong> 
                • From 2012 to latest M4 (2024) • Same-day service • Original quality displays • 3-month warranty
              </p>
            </div>
          </div>

          {/* Display all models grouped by category - Simple format that works reliably */}
          <div className="max-w-6xl mx-auto">
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-6 mb-12">
              <p className="text-center text-lg font-semibold text-gray-800">
                <strong>All {macBookProModels.reduce((total, category) => total + category.models.length, 0)} MacBook Pro Models Available</strong>
              </p>
              <p className="text-center text-sm text-gray-600 mt-2">
                From 2012 vintage to latest M4 (2024) • Same-day service • Original quality displays • 3-month warranty
              </p>
            </div>
            
            {/* Display all models grouped by category */}
            {macBookProModels.map((category, categoryIndex) => (
              <div key={category.category} className="mb-12">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold text-primary mb-2">{category.category}</h3>
                  <p className="text-muted-foreground">{category.models.length} models available</p>
                </div>
